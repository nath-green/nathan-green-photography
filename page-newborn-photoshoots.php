...
<div class="lg-container px-0 mb-10 lg:mt-10">
  <img class="object-cover w-full" src="<?php echo theme_url('img/ted-dufton-05-lg.jpg'); ?>" alt="Newborn baby boy yawning" />
</div>
...
<div class="bg-gray-200 border pt-12 pb-6">
  <div class="lg-container">
    ...
    <?php
      $i = 1;
      while(rwar_latest_posts(6, 'newborn-photoshoots')):
    ?>
