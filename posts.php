        ...
        <div class="px-6 py-4 flex flex-col flex-1">
          ...
          <header>
            <a href="<?php echo article_url(); ?>" title="<?php echo article_title(); ?>" itemprop="url">
              <h2 class="text-2xl mb-3 font-semibold font-title leading-tight" itemprop="name">
          ...
          <div class="flex">
            ...
            <div>
              ...
              <p class="text-gray-700 mb-5 text-xs">
                Posted <time datetime="<?php echo date(DATE_W3C, article_time()); ?>" itemprop="datePublished"
